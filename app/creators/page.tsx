...
export default function CreatorsPage(){return <PageShell>
  ...
  <section className="section creators-section"><CreatorsDirectory creators={creators}/><p className="creator-note">粉丝数据为整理时的公开数据，可能随平台变化；具体档期、报价与合作形式请联系 Dream 内容推广工作室确认。</p></section>
 </PageShell>}
