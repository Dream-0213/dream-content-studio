...
export default function CreatorsPage(){return <PageShell>
  <section className="subhero creator-hero"><div className="subhero-inner"><p className="eyebrow">CREATOR NETWORK</p><h1>合作博主名单</h1><p className="lead">覆盖公众号、CSDN、掘金、知乎等技术内容平台。品牌方可查看公开主页，自主选择匹配的合作创作者。</p><div className="creator-hero-links"><a className="creator-hero-link" href="#wechat-creators">优先查看公众号矩阵 ↓</a><a className="creator-hero-link creator-hero-link-csdn" href="#csdn-creators">优先查看 CSDN 博主矩阵 ↓</a></div></div></section>
