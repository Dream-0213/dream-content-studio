...
export default function ContactPage(){return <PageShell>
  ...
  <section className="section contact-grid"><div className="wechat-box"><div className="wechat-copy"><small>商务合作微信</small><strong>183 0039 6393</strong><p>微信昵称：是Dream呀<br/>添加时请备注「品牌 / 产品名称」，并简单说明推广方向，我们会尽快与你沟通。</p></div><div className="wechat-qr"><img src="/wechat-qr.png" alt="是Dream呀商务合作微信二维码"/><span>微信扫码添加好友</span></div></div><div className="contact-notes"><p className="eyebrow">BEFORE WE TALK</p><h2>准备这些信息，沟通会更高效</h2><ol><li>品牌或产品名称，以及核心技术方向</li><li>希望触达的开发者与目标平台</li><li>内容类型、计划数量与发布时间</li><li>可提供的产品资料、试用账号或技术文档</li><li>大致预算范围与评估指标</li></ol></div></section>
 </PageShell>}
