    ...
    <main id="main-content">
      <section className="hero">
        ...
        <div className="hero-copy">
          <h1><span>技术内容营销</span><br />让好产品被开发者看见</h1>
          <p className="hero-lead">为技术品牌提供内容策划、博主投放与多平台分发。</p>
          <div className="hero-actions">
            <Link href="/contact" className="button button-primary">获取推广方案</Link>
        ...
        <div className="hero-proof">
          <div className="hero-studio-proof"><span>CSDN</span><div><p>创作者网络与内容能力</p><strong>懂技术，也懂开发者传播</strong><small>终身合作伙伴 / 首席合作伙伴</small></div></div>
      ...
      <section className="section home-section intro-section">
        <div><h2>技术内容营销，<br />不只是发文章</h2></div>
        <div className="intro-copy">
          ...
          <Link href="/services/original-content" className="text-link">查看技术内容服务</Link>
        </div>
      </section>

      <section className="section home-section services-section" id="services">
        <div className="section-heading"><div><h2>从一篇好内容，<br />到一场有声量的传播</h2></div><p>单篇合作、长期运营，或数百位博主参与的大型项目，都由一个接口统一推进。</p></div>
        <ServiceGrid />
      </section>

      <section className="section home-section cases-section" id="cases">
        <div className="section-heading"><div><h2>真实技术推广案例，<br />链接与结果都能查看</h2></div><p>覆盖 CSDN KOL 投放、AI 开发工具、国产算力生态和长期内容矩阵，每个重点案例均可查看公开交付内容。</p></div>
        <CaseGrid />
      </section>

      <section className="section home-section identity-section">
        <div className="identity-image-wrap"><img src="/dream-profile.png" alt="Dream工作室技术内容推广与创作者资源介绍" width="1254" height="1254" /></div>
        <div className="identity-copy">
          ...
          <div className="identity-links"><Link href="/about" className="text-link">了解主理人与工作室</Link><Link href="/creators" className="text-link">查看合作博主矩阵</Link></div>
        </div>
      </section>
      ...
      <section className="section home-section join-section" id="join">
        <div className="join-intro">
          ...
          <Link href="/contact#join-application" className="button button-primary">申请加入</Link>
      ...
      <section className="workflow section home-section">
        <div className="workflow-head"><h2>博主由你挑，<br />执行由我负责。</h2><p>从需求梳理到内容上线，每一步都有明确交付，让大型博主项目也能清晰推进。</p></div>
        <ol>
      ...
      <section className="section home-section faq-section" id="faq">
        <div className="section-heading"><div><h2>技术品牌推广<br />常见问题</h2></div><p>从单篇原创到数百位博主参与的大型项目，都可以根据产品阶段、目标平台和预算灵活组合。</p></div>
        <div className="faq-list">{faqs.map(([question,answer],index)=><details key={question} open={index===0}><summary>{question}<span aria-hidden="true" /></summary><p>{answer}</p></details>)}</div>
      </section>

      <section className="section home-section final-cta">
        <h2>下一个被开发者看见的<br />技术品牌，会是你吗？</h2>
        <p>告诉我们产品方向、目标平台和推广规模，获取匹配的内容与博主合作方案。</p>
        <Link href="/contact" className="button button-light">商务合作</Link>
      </section>
    </main>
    <Footer />
