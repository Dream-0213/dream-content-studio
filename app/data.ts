...
export const cases = [
  ...
  },
  {
    ...
    result: "500 篇",
    resultLabel: "累计发布内容",
    summary: "在 CSDN、知乎、掘金等平台建立稳定周度发布机制，累计发布 500 篇内容，持续提升产品在搜索结果和技术社区中的曝光。",
    metrics: ["累计发布 500 篇", "持续合作半年以上", "形成成熟批量交付流程"],
  },
  {
    slug: "todesk-ai",
    client: "ToDesk AI",
  ...
  },
  {
    ...
    result: "300+",
    resultLabel: "技术文章产出",
    summary: "Dream 工作室组织 150 位万粉技术博主参与华为昇腾及鲲鹏项目。博主先完成课程培训和选题拆解，再进行实操验证、技术审核与多平台发布，最终产出 300+ 篇深度技术文章。",
    metrics: ["150 位万粉博主统一组织", "300+ 篇技术文章规模化交付", "覆盖 16 个核心技术专题"],
  },
  {
    slug: "360-ai",
    client: "CSDN × 360 AI",
